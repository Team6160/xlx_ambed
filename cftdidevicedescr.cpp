...
int CFtdiDeviceDescr::GetNbChannels(void) const
{
    ...
    if ( (::strcmp(m_szDescription, "USB-3000")   == 0) ||           // DVSI's USB-3000
         ...
         (::strcmp(m_szDescription, "ThumbDV A")  == 0) || 
         (::strcmp(m_szDescription, "ThumbDV B")  == 0) ||
         (::strcmp(m_szDescription, "ThumbDV C")  == 0) || 
         (::strcmp(m_szDescription, "ThumbDV D")  == 0) )
    {
        iNbChs = 1;
    }
    // three channels devices
...
CUsb3000Interface *CFtdiDeviceDescr::InstantiateUsb3000(CFtdiDeviceDescr *descr)
{
    ...
    if ( (::strcmp(descr->GetDescription(), "USB-3000")  == 0) ||           // DVSI's USB-3000
         ...
         (::strcmp(descr->GetDescription(), "ThumbDV A") == 0) ||
         (::strcmp(descr->GetDescription(), "ThumbDV B") == 0) ||
         (::strcmp(descr->GetDescription(), "ThumbDV C") == 0) ||
         (::strcmp(descr->GetDescription(), "ThumbDV D") == 0) ) 
   {
